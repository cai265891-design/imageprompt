...
import {
  provider,
  isWindows,
} from "file:///Users/caihongjia/saasfly/node_modules/std-env/dist/index.mjs";
import {
  defineEventHandler,
  handleCacheHeaders,
  splitCookiesString,
...
} from "file:///Users/caihongjia/saasfly/node_modules/ofetch/dist/node.mjs";
import destr from "file:///Users/caihongjia/saasfly/node_modules/destr/dist/index.mjs";
import {
  createCall,
  createFetch,
} from "file:///Users/caihongjia/saasfly/node_modules/unenv/runtime/fetch/index.mjs";
import { createHooks } from "file:///Users/caihongjia/saasfly/node_modules/hookable/dist/index.mjs";
import { klona } from "file:///Users/caihongjia/saasfly/node_modules/klona/dist/index.mjs";
import { snakeCase } from "file:///Users/caihongjia/saasfly/node_modules/scule/dist/index.mjs";
import defu, {
  defuFn,
} from "file:///Users/caihongjia/saasfly/node_modules/defu/dist/defu.mjs";
...
import {
  ...
  getQuery,
  withQuery,
} from "file:///Users/caihongjia/saasfly/node_modules/ufo/dist/index.mjs";
import {
  createStorage,
  prefixStorage,
} from "file:///Users/caihongjia/saasfly/node_modules/unstorage/dist/index.mjs";
import unstorage_47drivers_47fs from "file:///Users/caihongjia/saasfly/node_modules/unstorage/drivers/fs.mjs";
import {
  toRouteMatcher,
  createRouter,
} from "file:///Users/caihongjia/saasfly/node_modules/radix3/dist/index.mjs";
...
const serverAssets = [
  {
    baseName: "server",
    dir: "/Users/caihongjia/saasfly/apps/auth-proxy/assets",
  },
];
...
storage.mount(
  ...
  unstorage_47drivers_47fs({
    driver: "fs",
    readOnly: true,
    base: "/Users/caihongjia/saasfly/apps/auth-proxy",
...
storage.mount(
  ...
  unstorage_47drivers_47fs({
    driver: "fs",
    readOnly: false,
    base: "/Users/caihongjia/saasfly/apps/auth-proxy/.nitro",
    ignore: ["**/node_modules/**", "**/.git/**"],
  }),
);
storage.mount(
  ...
  unstorage_47drivers_47fs({
    driver: "fs",
    readOnly: false,
    base: "/Users/caihongjia/saasfly/apps/auth-proxy/.nitro/cache",
    ignore: ["**/node_modules/**", "**/.git/**"],
  }),
);
storage.mount(
  ...
  unstorage_47drivers_47fs({
    driver: "fs",
    base: "/Users/caihongjia/saasfly/apps/auth-proxy/.data/kv",
    ignore: ["**/node_modules/**", "**/.git/**"],
  }),
);
